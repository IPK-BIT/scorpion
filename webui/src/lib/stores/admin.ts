...
import type { KPI, MembershipRequest, Necessity, RegistrationRequest, ServiceCategory, ServiceProvider, UserDetail } from "./types";
...
export const necessities: Readable<Necessity[]> = readable(["mandatory","recommended", "optional"]);