<script lang="ts">
    let theme:string="mytheme";
</script>

<div data-theme="dark" class="flex justify-center p-4">
    <div class="rounded-box bg-base-100 border-base-content/5 text-base-content not-prose grid gap-3 border p-6" data-theme={theme} style="--p:102 59% 26%; --s:102 93% 62%; --a:181 100% 49%; --n:0 0% 90%; --b1:101 89% 93%; --in:198 93% 60%; --su:158 64% 52%; --wa:43 96% 56%; --er:0 91% 71%; --pf:102 58% 21%; --sf:101 93% 49%; --af:181 100% 39%; --nf:0 0% 72%; --b2:101 88% 84%; --b3:101 89% 74%; --bc:101 74% 19%; --pc:102 100% 85%; --sc:102 100% 12%; --ac:181 100% 10%; --nc:0 0% 18%; --inc:198 100% 12%; --suc:158 100% 10%; --wac:43 100% 11%; --erc:0 100% 14%;">
